...
- **Cloud Platform:** Amazon Web Services, Google Cloud Platform, Microsoft Azure, OpenStack
- **Containerization & Orchestration:** Docker, Podman, Docker Compose, Kubernetes, Helm
- **Operating System:** SUSE Linux Enterprise Server, Red Hat Enterprise Linux, Ubuntu, Amazon Linux
- **Infrastructure as Code & Configuration:** Terraform, Ansible, Terragrunt
- **Monitoring & Logging:** Grafana, Prometheus, Graylog, Zabbix, Alertmanager, AWS CloudWatch
- **CI/CD:** GitHub Actions, GitLab CI/CD, Jenkins, AWS CodeBuild, AWS CodePipeline, FluxCD
- **Programming & Scripting:** Node.js, Python, Bash
- **Other Tools:** Ceph, MinIO, RabbitMQ, Redis, External Secrets, Karpenter, KVM, Kyverno
...
### **Accenture**
*Cloud Platform Engineer - Senior Analyst* | Semarang, Indonesia | **12/2024 - Present**
...
- Developed AWS automation for EC2, AMI, and EBS lifecycle operations, reducing execution time by 50%+, eliminating
manual console intervention, and minimizing risk of human error.
- Developed Ansible playbooks for LVM-based volume and filesystem creation, cross-platform patching, and user
management, reducing execution time by over 40%.
- Refactored legacy playbooks into role-based frameworks and secured sensitive variables with Ansible Vault, improving
maintainability and secrets hygiene.
- Drove DevOps adoption by deploying Gitea, enabling developer Git adoption through technical workshops, and
establishing standardized version control workflows.
- Led SUSE Linux upgrade POC, producing repeatable Method of Procedures (MOPs) that reduced upgrade risk and
enabled consistent OS lifecycle operations at scale.
- Mentored an intern and delivered training sessions, including a 2-day AWS workshop for 35+ participants with 90%
satisfaction

### **Feedloop AI**
*DevOps Engineer* | Remote | **12/2023 - 12/2024**
...
### **Boer Technology**
*Cloud Operation Engineer* | Remote | **12/2022 - 11/2023**
...
- Deployed and maintained monitoring and logging solutions for OpenStack, Ceph, Kubernetes, and bare-metal nodes. Utilized tools such as Grafana, Prometheus, Alertmanager, Node Exporter, Graylog, and Zabbix to ensure comprehensive visibility and operational insights.
...
### **Previous Roles**
- **Bangkit Academy 2023** | *Cloud Computing Mentor* | Remote | **02/2023 - 07/2023**
- **Tamtech International** | *Backend Developer Intern* | Sleman, Yogyakarta | **06/2022 - 09/2022**
- **Torche Education** | *Cloud Engineer Intern* | Remote | **06/2022 - 09/2022**
...
### Certifications
- **AWS Certified Solutions Architect - Associate** *(08/2025)*
- **AWS Certified Developer Associate** *(11/2022)*
- **Google Cloud Certified Professional Cloud Architect** *(10/2022)*
- **Google Cloud Certified Associate Cloud Engineer** *(07/2025)*
- **Alibaba Cloud Associate - Cloud Computing** *(08/2022)*
- **Alibaba Cloud Associate - System Operator** *(08/2022)*
- **Alibaba Cloud Associate - Cloud Security** *(09/2022)*

### Training & Bootcamps
- **Cloud Developing Program (AWS)** by Digital Talent Scholarship *(08/2022 - 09/2022)*
- **Cloud Engineering Bootcamp** by Btech Academy *(06/2022 - 07/2022)*
- **Cloud Computing Training** by Bangkit Academy, Google, Goto, Traveloka *(02/2022 - 07/2022)*
